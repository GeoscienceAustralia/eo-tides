...
The [`eo_tides.eo`](https://geoscienceaustralia.github.io/eo-tides/api/#eo_tides.eo) module contains the package's core functionality, focusing on tools for attributing `xarray`-format satellite data with modelled tide heights.
