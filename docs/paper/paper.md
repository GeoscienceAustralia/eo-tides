...
![An example tide height output produced by the `pixel_tides` function, showing spatial variability in tides across the Australiasian region for a single timestep.\label{fig:pixel}](figures/joss_fig_pixel.png)
